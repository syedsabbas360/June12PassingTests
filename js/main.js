...
/*************************************************************************************
------------ ANSWER -------------------
This anonymous function will return 'I'm a local variable'.  This is due to the function simply defining var y inside the function but it doesn't do anything with it.  Instead, we're simply console logging the variable x's value which will refer to the var x value outside of the scopeThis() function.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will log 'undefined' since it is assigned a value after it's logged.  console.log(y) will also log 'undefined' since it is not defined/declared before it's logged to the console.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
The console.log(add) inside the IFEE will print 4 since constant add is defined within the anonymous function which is called IMMEDIATELY.  However, since const add only has a local scope, when it's refered to outside of the function, it will log as 'undefined'.
**************************************************************************************/
